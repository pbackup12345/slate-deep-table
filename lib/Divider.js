  ...
  const onMouseOver = e => {
    if (e.target.nextElementSibling) {
      e.target.style.height =
        e.target.parentElement.parentElement.parentElement.parentElement.offsetHeight + "px";
      e.target.style.borderRight = "2px solid #0000ff";
      e.target.nextElementSibling.style.opacity = 1;
    } else {
      e.target.previousElementSibling.style.height =
        e.target.previousElementSibling.parentElement.parentElement.parentElement.parentElement
          .offsetHeight + "px";
  ...
  return (
    <React.Fragment>
      ...
      <div
        ...
        <Icon icon="add" color="green" iconSize={10} />
      </div>
    </React.Fragment>
  );
};
