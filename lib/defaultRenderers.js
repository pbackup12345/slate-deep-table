 ...
 */
const makeRenderers = (opts = { mouseDown: noop, mouseUp: noop, mouseMove: noop }) => (
  props,
  editor,
  next
) => {
    ...
    case opts.typeTable:
      ...
      return (
        <div
          ...
          <table className={properties.tableClassName} style={properties.tableStyle || {}}>
            {header && (
              <thead
          ...
          {opts.tableResize || props.node.data.get("tableResize") ? <Resizer /> : ""}
        </div>
      );
    case opts.typeRow:
      properties = {
      ...
      return (
        <tr className={properties.className} style={properties.style} {...props.attributes}>
          {props.children}
        </tr>
      );
    case opts.typeCell:
      ...
      const prevCell = !!props.editor.value.document.getPreviousSibling(props.node.key);
      const nextCell = !!props.editor.value.document.getNextSibling(props.node.key);
          ...
          {prevRow || headerless ? (
            <React.Fragment>
              <td
                ...
                {...props.attributes}>
                {!prevRow && !prevCell ? (
                  <Divider editor={props.editor} node={props.node} first={true} />
                ) : (
                  ""
                )}
                {props.children}
                {!prevRow ? (
                  <Divider editor={props.editor} node={props.node} last={nextCell} />
                ) : (
                  ""
                )}
              </td>
            ...
            <React.Fragment>
              <th
                ...
                {...attributes}
                {...props.attributes}>
                {!prevCell ? <Divider editor={props.editor} node={props.node} first={true} /> : ""}
                {props.children}
                <Divider editor={props.editor} node={props.node} last={!nextCell} />
              </th>
            </React.Fragment>
